...
/**
    ...
    public static void readTable(){
        ...
        saveImage("D:/out-table/1-thresh.png",thresh_image);
        ...
        saveImage("D:/out-table/2-horizontal.png",horizontal_image);
        ...
        saveImage("D:/out-table/3-vertical.png",vertical_image);
        ...
        saveImage("D:/out-table/4-mask.png",mask_image);
        ...
        saveImage("D:/out-table/5-points.png",points_image);
        ...
        for(int i=0; i< tables.size(); i++ ){
            ...
            saveImage("D:/out-table/6-table-"+(i+1)+".png",tables.get(i));
        }

        saveImage("D:/out-table/7-source.png",source_image);
